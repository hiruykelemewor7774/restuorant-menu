...
export default function TableManagementPage() {
  ...
  return (
    <div className="ml-100 flex text-white mr-200">
      <main className="flex-1 p-10 mx-auto w-200">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 width-100">
          {tables.map((t) => (
            <div key={t.id} className="bg-gray-900 border border-gray-800 p-6 rounded-2xl flex flex-col items-center justify-between shadow-xl [min-h-360px]">
